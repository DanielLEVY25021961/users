...
/**
 * class AbstractFunctionalException :
 * <ul>
 * <li>Classe <b>abstraite</b> de base commune a toutes les exceptions 
 * fonctionnelles <b>VERIFIEES</b> susceptibles d'être catchées dans le code 
 ...
 * Exceptions Fonctionnelles VERIFIEES héritant de AbstractFunctionalException 
...
public abstract class AbstractFunctionalException extends Exception {
	...
	private static final Log LOG = LogFactory
			.getLog(AbstractFunctionalException.class);

	// *************************METHODES************************************/
	

	/**
	 * method CONSTRUCTEUR AbstractFunctionalException() :<br/>
	 * <ul>
	 * <li>CONSTRUCTEUR D'ARITE NULLE.</li>
	 * <li>Permet de construire une AbstractFunctionalException
	...
	} // Fin de AbstractFunctionalException(.______________________________
	


	/**
	 * method CONSTRUCTEUR AbstractFunctionalException(
	 * String pMessage) :<br/>
	 * <ul>
	 ...
	 */
	public AbstractFunctionalException(final String pMessage) {
	...
	} // Fin de CONSTRUCTEUR AbstractFunctionalException(
	 ...
	 */
	public AbstractFunctionalException(final Throwable pCause) {
...
} // FIN DE LA CLASSE AbstractFunctionalException.----------------------------
