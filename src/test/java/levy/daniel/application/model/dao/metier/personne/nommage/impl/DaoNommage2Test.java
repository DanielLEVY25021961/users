...
import levy.daniel.application.model.dao.metier.personne.nommage.IDaoNommage;
...
/**
 * class DaoNommage2Test :<br/>
 * <ul>
 * <li>Test JUnit de la classe <b>DaoNommage2</b>.</li>
...
public class DaoNommage2Test {
	 ...
	 * "Albert".<br/>
	 */
	public static final String PRENOM2_1 
		= "Albert";
	 ...
	 * "Alphonse".<br/>
	 */
	public static final String PRENOM2_2 
		= "Alphonse";
	 ...
	 * "Zorro".<br/>
	 */
	public static final String PRENOM2_3 
		= "Zorro";


	/**
	 * daoNommage : IDaoNommage :<br/>
	 * DAO pour les Nommage.<br/>
	 * INJECTE PAR SPRING (Autowired).<b/>
	 */
	@Autowired
	@Qualifier(value="DaoNommage")
	private transient IDaoNommage daoNommage;
	

	/**
	 * daoNommage2 : IDaoNommage :<br/>
	 * DAO pour les Nommage2.<br/>
	 * INJECTE PAR SPRING (Autowired).<b/>
	 */
	@Autowired
	@Qualifier(value="DaoNommage2")
	private transient IDaoNommage daoNommage2;
	 ...
	 */
	private static final Log LOG = LogFactory.getLog(DaoNommage2Test.class);
	...
	/**
	* method CONSTRUCTEUR DaoNommage2Test() :<br/>
	* CONSTRUCTEUR D'ARITE NULLE.<br/>
	* <br/>
	*/
	public DaoNommage2Test() {
		super();
	...
	public void testCreateNull() throws AbstractDaoException {
		...
		/* daoNommage2 NON INJECTE. */
		if (this.daoNommage2 == null) {
			...
			return;
		} // Fin de daoNommage2 NON INJECTE._______________
		...
		final INommage objet1 = null;
		INommage objet1Persistant = null;
						
		/* Compte du nombre d'Objets initialement en base. */
		nombreObjetsinitial = this.daoNommage2.count();
		...
		try {
			...
			/* *********************************************** */
			/* ********************* CREATION **************** */
			objet1Persistant = this.daoNommage2.create(objet1);
			/* *********************************************** */
			
			/* Calcul du nombre d'objets en base après le traitement. */
			nombreObjetsFinal = this.daoNommage2.count();
	 ...
	 * <ul>
	 * Teste la méthode <b>create(INommage pObject)</b>.<br/>
	 * <li>garantit que create(INommage pObject) insère 
	 * un objet en base.</li>
	 * </ul>
	 * 
	 * @throws AbstractDaoException 
	...
	public void testCreate() throws AbstractDaoException {
		...
		INommage objet1Persistant = null;
		INommage objet2Persistant = null;
		INommage objet3Persistant = null;
		
		/* Instanciation d'un ProfilSimple. */
		final INommage objet1 
		= new Nommage2(PRENOM1, PRENOM2_1, NOM1);
		
		final INommage objet2 
		= new Nommage2(PRENOM2, PRENOM2_2, NOM2);
		...
		try {
			...
			/* ********************* CREATION **************** */
			objet1Persistant = this.daoNommage2.create(objet1);
			objet2Persistant = this.daoNommage2.create(objet2);
			/* *********************************************** */
		...
		final INommage objet3 
			= new Nommage2(PRENOM3, PRENOM2_3, NOM3);
		
		try {
			
			/* *********************************************** */
			/* ********************* CREATION **************** */
			objet3Persistant = this.daoNommage2.create(objet3);
		...
		final INommage objet4 = new Nommage("Daniel", "Lévy");
		final INommage objet5 = new Nommage("David", "Lévy");
		
		INommage objet4Persistant = null;
		INommage objet5Persistant = null;
		
		objet4Persistant = this.daoNommage.create(objet4);
		objet5Persistant = this.daoNommage.create(objet5);
		
		nombreObjetsFinal = this.daoNommage.count();
		...
		if (AFFICHAGE_GENERAL && affichage) {
			...
			System.out.println(TEST_CREATE);
			System.out.println("NOMBRE D'OBJETS PERSISTES APRES CREATE : " + nombreObjetsFinal);
			if (objet4Persistant != null) {
				System.out.println(
						"OBJET4 PERSISTANT APRES Create(T Object) : " 
				+ objet4Persistant.toString());
			} else {
				System.out.println(
						"OBJET4 PERSISTANT APRES Create(T Object) : null");
			}
			
			if (objet5Persistant != null) {
				System.out.println(
						"OBJET5 PERSISTANT APRES Create(T Object) : " 
								+ objet5Persistant.toString());
			} else {
				System.out.println(
						"OBJET5 PERSISTANT APRES Create(T Object) : null");
			}
	 ...
	 * <ul>
	 * Teste la méthode <b>create(INommage pDoublon)</b>.<br/>
	 * <li>garantit que create(INommage pDoublon) retourne 
	...
	public void testCreateDoublon() 
		...
		INommage objet1Persistant = null;
		INommage objet2PersistantEquals1 = null;
		...
		try {
			...
			/* ********************* CREATION **************** */
			objet1Persistant = this.daoNommage2.create(objet1);
			objet2PersistantEquals1 = this.daoNommage2.create(objet2Equals1);
			/* *********************************************** */
	...
	public void testSaveNull() throws AbstractDaoException {
		...
		try {
			...
			/* *********************************************** */
			/* ********************* CREATION **************** */
			objet1Persistant = this.daoNommage2.save(objet1);
			/* *********************************************** */
	 ...
	 * method testSave() :<br/>
	 * <ul>
	 * Teste la méthode <b>save(INommage pObject)</b>.<br/>
	 * <li>garantit que save(INommage pObject) insère 
	 * un objet en base.</li>
	 * </ul>
	 * 
	 * @throws AbstractDaoException 
	 ...
	 * <ul>
	 * Teste la méthode <b>save(INommage pDoublon)</b>.<br/>
	 * <li>garantit que save(INommage pDoublon) retourne 
	 * null sans lever d'Exception.</li>
	 * </ul>
	 * 
	 * @throws AbstractDaoException 
	...
	public void testSaveDoublon() 
		...
		try {
			...
			/* ********************* CREATION **************** */
			objet1Persistant = this.daoNommage2.save(objet1);
			objet2PersistantEquals1 = this.daoNommage2.save(objet2Equals1);
			/* *********************************************** */
	...
	public void testPersistNull() throws AbstractDaoException {
		...
		try {
			...
			/* *********************************************** */
			/* ********************* CREATION **************** */
			this.daoNommage2.persist(objet1);
			objet1Persistant = this.daoNommage2.retrieve(objet1);
			/* *********************************************** */
	 ...
	 * <ul>
	 * Teste la méthode <b>persist(INommage pObject)</b>.<br/>
	 * <li>garantit que persist(INommage pObject) insère 
	 * un objet en base.</li>
	 * </ul>
	 * 
	 * @throws AbstractDaoException 
	 ...
	 * <ul>
	 * Teste la méthode <b>persist(INommage pDoublon)</b>.<br/>
	 * <li>garantit que persist(INommage pDoublon) ne fait 
	...
	public void testPersistDoublon() 
		...
		try {
			...
			/* ********************* CREATION **************** */
			this.daoNommage2.persist(objet1);
			this.daoNommage2.persist(objet2Equals1);
			objet1Persistant = this.daoNommage2.retrieve(objet1);
			objet2PersistantEquals1 = this.daoNommage2.retrieve(objet2Equals1);
			/* *********************************************** */
	...
	public void testPersistSousClasseNull() throws AbstractDaoException {
		...
		try {
			...
			/* *********************************************** */
			/* ********************* CREATION **************** */
			this.daoNommage2.persistSousClasse(objet1);
			objet1Persistant = this.daoNommage2.retrieve(objet1);
			/* *********************************************** */
	 ...
	 * <ul>
	 * Teste la méthode 
	 * <b>persistSousClasse(INommage pObject)</b>.<br/>
	 * <li>garantit que persistSousClasse(INommage pObject) insère 
	 * un objet en base.</li>
	 * </ul>
	 * 
	 * @throws AbstractDaoException 
	 ...
	 * <ul>
	 * Teste la méthode 
	 * <b>persistSousClasse(INommage pDoublon)</b>.<br/>
	 * <li>garantit que persistSousClasse(INommage pDoublon) 
	...
	public void testPersistSousClasseDoublon() 
		...
		try {
			...
			/* ********************* CREATION **************** */
			this.daoNommage2.persistSousClasse(objet1);
			this.daoNommage2.persistSousClasse(objet2Equals1);
			objet1Persistant = this.daoNommage2.retrieve(objet1);
			objet2PersistantEquals1 = this.daoNommage2.retrieve(objet2Equals1);
			/* *********************************************** */
	...
	public void testCreateReturnIdNull() throws AbstractDaoException {
		...
		try {
			...
			/* *********************************************** */
			/* ********************* CREATION **************** */
			idObjetPersistant = this.daoNommage2.createReturnId(objet1);
			objet1Persistant = this.daoNommage2.findById(idObjetPersistant);
			/* *********************************************** */
	 ...
	 * <ul>
	 * Teste la méthode <b>createReturnId(INommage pObject)</b>.<br/>
	 * <li>garantit que createReturnId(INommage pObject) insère 
	 ...
	 * <ul>
	 * Teste la méthode <b>createReturnId(INommage pDoublon)</b>.<br/>
	 * <li>garantit que createReturnId(INommage pDoublon) retourne 
	 * null sans lever d'Exception.</li>
	 * </ul>
	 * 
	 * @throws AbstractDaoException 
	...
	public void testCreateReturnIdDoublon() 
		...
		try {
			...
			/* *********************************************** */
			/* ********************* CREATION **************** */
			idObjet1Persistant = this.daoNommage2.createReturnId(objet1);
			idObjet2PersistantEquals1 = this.daoNommage2.createReturnId(objet2Equals1);
			objet1Persistant = this.daoNommage2.findById(idObjet1Persistant);
			objet2PersistantEquals1 = this.daoNommage2.findById(idObjet2PersistantEquals1);
			/* *********************************************** */
	...
	public void testSaveLot() 
		...
		List<INommage> lotPersistant = null;
		
		/* Instanciation de ProfilSimple. */
		final INommage objet1 
		= new Nommage2(PRENOM1, PRENOM2_1, NOM1);
		
		final INommage objet2Null = null;
		
		final INommage objet3Equals1 
		= new Nommage2(PRENOM1, PRENOM2_1, NOM1);
		
		final INommage objet4 
		= new Nommage2(PRENOM2, PRENOM2_2, NOM2);
		
		/* Constitution d'un lot d'objets. */
		final List<INommage> lot = new ArrayList<INommage>();
		...
		try {
			...
			/* *********************************************** */
			/* ********************* CREATION **************** */
			lotPersistant = (List<INommage>) this.daoNommage2.save(lot);
			/* *********************************************** */
		...
		if (AFFICHAGE_GENERAL && affichage) {
			...
			System.out.println(this.daoNommage2.afficherListe(lotPersistant));
			System.out.println(TIRETS);
			System.out.println();
	 ...
	 * <ul>
	 * Teste la méthode <b>retrieve(INommage pObject)</b>.<br/>
	 * <li>garantit que retrieve(INommage pObject) retrouve 
	...
	public void testRetrieve() 
		...
		INommage objetpersistantInexistant = null;
		...
		final INommage objet5 
		= new Nommage2(PRENOM3, PRENOM2_3, NOM3);
		
		final INommage objetInexistant 
		= new Nommage2("Pouetr* Pouet", INEXISTANT, INEXISTANT);
		...
		/* *********************************************** */
		/* ********************* RETRIEVE **************** */
		objetpersistantInexistant = this.daoNommage2.retrieve(objetInexistant);
		...
		/* *********************************************** */
		/* ********************* RETRIEVE **************** */
		objetpersistant = this.daoNommage2.retrieve(objet5);
	...
	public void testFindById() 
		...
		/* *********************************************** */
		/* ********************* FINDBYID **************** */
		objetpersistantInexistant = this.daoNommage2.findById(100L);
		...
		/* *********************************************** */
		/* ********************* FINDBYID **************** */
		objetpersistant = this.daoNommage2.findById(3L);
	...
	public void testFindAll() 
		...
		/* *********************************************** */
		/* ********************* FINDALL ***************** */
		lotPersistant = this.daoNommage2.findAll();
	...
	public void testFindAllMax() 
		...
		/* *********************************************** */
		/* ********************* FINDALLMax ************** */
		lotPersistant = this.daoNommage2.findAllMax(2L);
	...
	public void testFindAllIterable() 
		...
		List<INommage> lotPersistant = null;
		Iterable<INommage> lotPersistantIterable = null;
		...
		/* *********************************************** */
		/* ***************** FINDALL(Ite) **************** */
		lotPersistantIterable = this.daoNommage2.findAll(listIds);
		...
		if (lotPersistant != null) {
			...
			final boolean exists1 = this.daoNommage2.exists(1L);
			final boolean exists2 = this.daoNommage2.exists(2L);
	...
	public void testUpdateInexistant() 
		...
		final INommage objetInexistant 
		= new Nommage2(INEXISTANT, INEXISTANT, INEXISTANT);
		...
		/* ***************** UPDATE(Objet) **************** */
		objetpersistantInexistant 
			= this.daoNommage2.update(objetInexistant);
	...
	public void testUpdate() 
		...
		INommage objet1 = null;
		INommage objet1Persistant = null;
		INommage objet1ModifiePersistant = null;
		...
		/* ************** */
		/* Modifications. */
		objet1Persistant.setNom("Modifié");

		
		/* ************************************************ */
		/* ***************** UPDATE(Objet) **************** */
		objet1ModifiePersistant = this.daoNommage2.update(objet1Persistant);
	...
	public void testDeleteInexistant() 
		...
		List<INommage> lotPersistant = null;
		List<INommage> lotPersistantApresDelete = null;
		...
		/* remplit de la table. */
		this.remplirTable(affichage);
		this.daoNommage2.create(objet1);
		...
		/* ************************************************ */
		/* ***************** DELETE(Objet) **************** */
		resultat = this.daoNommage2.delete(objetInexistant);
	
		
		nombreObjetsFinal = this.daoNommage2.count();
		
		lotPersistantApresDelete = this.daoNommage2.findAll();
		...
		if (AFFICHAGE_GENERAL && affichage) {
			...
			System.out.println(this.daoNommage2.afficherListe(lotPersistantApresDelete));
			System.out.println(TIRETS);
			System.out.println();
	...
	public void testDelete() 
		...
		/* ************************************************ */
		/* ***************** DELETE(Objet) **************** */
		resultat = this.daoNommage2.delete(objet1);
	...
	public void testDeleteByIdInexistant() 
		...
		/* **************************************************** */
		/* ***************** DELETEBYID(Objet) **************** */
		this.daoNommage2.deleteById(100L);
	...
	public void testDeleteById() 
		...
		/* ************************************************ */
		/* ***************** DELETEBYID(Objet) **************** */
		this.daoNommage2.deleteById(idExistant);
	...
	public void testDeleteByIdBooleanInexistant() 
		...
		resultat = this.daoNommage2.deleteByIdBoolean(100L);
	...
	public void testDeleteByIdBoolean() 
		...
		/* ************************************************ */
		/* ***************** DELETE(Objet) **************** */
		resultat = this.daoNommage2.deleteByIdBoolean(idExistant);
	 ...
	 * Remplit les tables ABSTRACT_NOMMAGES 
	 * et NOMMAGES avec 3 enregistrements.<br/>
	 * <br/>
	 * 
	...
	private void remplirTable(
		...
		final Long nbeObjetsFinal = this.daoNommage2.count();
	...
	private void viderTable() throws AbstractDaoException {
		...
		this.daoNommage2.deleteAll();
		
		final Long nbreObjetsFinal = this.daoNommage2.count();
	 ...
	 * <b>"DAO NON INSTANCIE - this.daoNommage2 est NULL"</b>.<br/>
	 * <br/>
	 */
	 ...
	 * <br/>
	 *
	 * @param pObjetPersistant : INommage : 
	...
	private void afficherObjetPersistant(
			final INommage pObjetPersistant
	 ...
	 * Iterable<INommage> pIterable) :<br/>
	 * fabrique une liste à partir d'un Iterable.<br/>
	 * <br/>
	 *
	 * @param pIterable : Iterable<INommage>.<br/>
	 * 
	 * @return : List<INommage>.<br/>
	 */
	public final List<INommage> fabriquerList(
			final Iterable<INommage> pIterable) {
		
		final List<INommage> list = new ArrayList<INommage>();
		
	    for (final INommage item : pIterable) {
	        list.add(item);
	    }
...
} // FIN DE LA CLASSE DaoNommage2Test.---------------------------------------
