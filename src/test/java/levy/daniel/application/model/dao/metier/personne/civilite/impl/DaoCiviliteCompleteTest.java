...
/**
 * class DaoCiviliteCompleteTest :<br/>
 * <ul>
 * <li>Test JUnit de la classe <b>DaoCiviliteComplete</b>.</li>
...
public class DaoCiviliteCompleteTest {
	...
	private static final Log LOG 
		= LogFactory.getLog(DaoCiviliteCompleteTest.class);

	// *************************METHODES************************************/

		
	 /**
	 * method CONSTRUCTEUR DaoCiviliteCompleteTest() :<br/>
	 * CONSTRUCTEUR D'ARITE NULLE.<br/>
	 * <br/>
	 */
	public DaoCiviliteCompleteTest() {
		super();
	...
	public void testCreateNull() throws AbstractDaoException {
		...
		/* daoCiviliteComplete NON INJECTE. */
		if (this.daoCiviliteComplete == null) {
			...
			return;
		} // Fin de daoCiviliteComplete NON INJECTE._______________
		...
		nombreObjetsinitial = this.daoCiviliteComplete.count();
		...
		try {
			...
			/* *********************************************** */
			/* ********************* CREATION **************** */
			objet1Persistant = this.daoCiviliteComplete.create(objet1);
			/* *********************************************** */
			
			/* Calcul du nombre d'objets en base après le traitement. */
			nombreObjetsFinal = this.daoCiviliteComplete.count();
	...
	public void testCreate() throws AbstractDaoException {
		...
		/* Instanciation d'un CiviliteComplete. */
		...
		try {
			...
			/* ********************* CREATION **************** */
			objet1Persistant = this.daoCiviliteComplete.create(objet1);
			objet2Persistant = this.daoCiviliteComplete.create(objet2);
			/* *********************************************** */
			
			nombreObjetsFinal = this.daoCiviliteComplete.count();
			
			/* garantit que create(CiviliteComplete pObject) 
		...
		try {
			...
			/* *********************************************** */
			/* ********************* CREATION **************** */
			objet3Persistant = this.daoCiviliteComplete.create(objet3);
		...
		this.daoCiviliteAbregee.create(objet4);
		this.daoCiviliteAbregee.create(objet5);
		this.daoCiviliteAbregee.create(objet6);
	 ...
	 * <ul>
	 * Teste la méthode <b>create(CiviliteComplete pDoublon)</b>.<br/>
	 * <li>garantit que create(CiviliteComplete pDoublon) retourne 
	...
	public void testCreateDoublon() 
		...
		try {
			...
			/* ********************* CREATION **************** */
			objet1Persistant = this.daoCiviliteComplete.create(objet1);
			objet2PersistantEquals1 = this.daoCiviliteComplete.create(objet2Equals1);
			/* *********************************************** */
	...
	public void testSaveNull() throws AbstractDaoException {
		...
		try {
			...
			/* *********************************************** */
			/* ********************* CREATION **************** */
			objet1Persistant = this.daoCiviliteComplete.save(objet1);
			/* *********************************************** */
	 ...
	 * method testSave() :<br/>
	 * <ul>
	 * Teste la méthode <b>save(CiviliteComplete pObject)</b>.<br/>
	 * <li>garantit que save(CiviliteComplete pObject) insère 
	 * un objet en base.</li>
	 * </ul>
	 * 
	 * @throws AbstractDaoException 
	...
	public void testSave() throws AbstractDaoException {
		...
		try {
			...
			/* garantit que save(CiviliteComplete pObject) 
			 * insère un objet en base.*/
			assertTrue(NBRE_OBJETS_FINAL_DOIT
					+ NBRE_INITIAL_PLUS_UN
					, nombreObjetsFinal == nombreObjetsinitial + 1);
	 ...
	 * <ul>
	 * Teste la méthode <b>save(CiviliteComplete pDoublon)</b>.<br/>
	 * <li>garantit que save(CiviliteComplete pDoublon) retourne 
	 * null sans lever d'Exception.</li>
	 * </ul>
	 * 
	 * @throws AbstractDaoException 
	...
	public void testSaveDoublon() 
		...
		try {
			...
			/* ********************* CREATION **************** */
			objet1Persistant = this.daoCiviliteComplete.save(objet1);
			objet2PersistantEquals1 = this.daoCiviliteComplete.save(objet2Equals1);
			/* *********************************************** */
	...
	public void testPersistNull() throws AbstractDaoException {
		...
		try {
			...
			/* *********************************************** */
			/* ********************* CREATION **************** */
			this.daoCiviliteComplete.persist(objet1);
			objet1Persistant = this.daoCiviliteComplete.retrieve(objet1);
			/* *********************************************** */
	 ...
	 * <ul>
	 * Teste la méthode <b>persist(CiviliteComplete pObject)</b>.<br/>
	 * <li>garantit que persist(CiviliteComplete pObject) insère 
	 * un objet en base.</li>
	 * </ul>
	 * 
	 * @throws AbstractDaoException 
	...
	public void testPersist() throws AbstractDaoException {
		...
		try {
			...
			/* garantit que persist(CiviliteComplete pObject) 
			 * insère un objet en base.*/
			assertTrue(NBRE_OBJETS_FINAL_DOIT
					+ NBRE_INITIAL_PLUS_UN
					, nombreObjetsFinal == nombreObjetsinitial + 1);
	 ...
	 * <ul>
	 * Teste la méthode <b>persist(CiviliteComplete pDoublon)</b>.<br/>
	 * <li>garantit que persist(CiviliteComplete pDoublon) ne fait 
	...
	public void testPersistDoublon() 
		...
		try {
			...
			/* ********************* CREATION **************** */
			this.daoCiviliteComplete.persist(objet1);
			this.daoCiviliteComplete.persist(objet2Equals1);
			objet1Persistant = this.daoCiviliteComplete.retrieve(objet1);
			objet2PersistantEquals1 = this.daoCiviliteComplete.retrieve(objet2Equals1);
			/* *********************************************** */
	...
	public void testPersistSousClasseNull() throws AbstractDaoException {
		...
		try {
			...
			/* *********************************************** */
			/* ********************* CREATION **************** */
			this.daoCiviliteComplete.persistSousClasse(objet1);
			objet1Persistant = this.daoCiviliteComplete.retrieve(objet1);
			/* *********************************************** */
	 ...
	 * <ul>
	 * Teste la méthode 
	 * <b>persistSousClasse(CiviliteComplete pObject)</b>.<br/>
	 * <li>garantit que persistSousClasse(CiviliteComplete pObject) insère 
	 * un objet en base.</li>
	 * </ul>
	 * 
	 * @throws AbstractDaoException 
	...
	public void testPersistSousClasse() throws AbstractDaoException {
		...
		try {
			...
			/* garantit que persistSousClasse(CiviliteComplete pObject) 
			 * insère un objet en base.*/
			assertTrue(NBRE_OBJETS_FINAL_DOIT
					+ NBRE_INITIAL_PLUS_UN
					, nombreObjetsFinal == nombreObjetsinitial + 1);
	 ...
	 * <ul>
	 * Teste la méthode 
	 * <b>persistSousClasse(CiviliteComplete pDoublon)</b>.<br/>
	 * <li>garantit que persistSousClasse(CiviliteComplete pDoublon) 
	...
	public void testPersistSousClasseDoublon() 
		...
		try {
			...
			/* ********************* CREATION **************** */
			this.daoCiviliteComplete.persistSousClasse(objet1);
			this.daoCiviliteComplete.persistSousClasse(objet2Equals1);
			objet1Persistant = this.daoCiviliteComplete.retrieve(objet1);
			objet2PersistantEquals1 = this.daoCiviliteComplete.retrieve(objet2Equals1);
			/* *********************************************** */
	...
	public void testCreateReturnIdNull() throws AbstractDaoException {
		...
		try {
			...
			/* *********************************************** */
			/* ********************* CREATION **************** */
			idObjetPersistant = this.daoCiviliteComplete.createReturnId(objet1);
			objet1Persistant = this.daoCiviliteComplete.findById(idObjetPersistant);
			/* *********************************************** */
	 ...
	 * <ul>
	 * Teste la méthode <b>createReturnId(CiviliteComplete pObject)</b>.<br/>
	 * <li>garantit que createReturnId(CiviliteComplete pObject) insère 
	 ...
	 * <ul>
	 * Teste la méthode <b>createReturnId(CiviliteComplete pDoublon)</b>.<br/>
	 * <li>garantit que createReturnId(CiviliteComplete pDoublon) retourne 
	 * null sans lever d'Exception.</li>
	 * </ul>
	 * 
	 * @throws AbstractDaoException 
	...
	public void testCreateReturnIdDoublon() 
		...
		try {
			...
			/* *********************************************** */
			/* ********************* CREATION **************** */
			idObjet1Persistant = this.daoCiviliteComplete.createReturnId(objet1);
			idObjet2PersistantEquals1 = this.daoCiviliteComplete.createReturnId(objet2Equals1);
			objet1Persistant = this.daoCiviliteComplete.findById(idObjet1Persistant);
			objet2PersistantEquals1 = this.daoCiviliteComplete.findById(idObjet2PersistantEquals1);
			/* *********************************************** */
	...
	public void testSaveLot() 
		...
		/* Instanciation de CiviliteComplete. */
		final ICivilite objet1 
		= new CiviliteComplete(CivilitesEnum.MONSIEUR.toString());
		...
		try {
			...
			/* *********************************************** */
			/* ********************* CREATION **************** */
			lotPersistant = (List<ICivilite>) this.daoCiviliteComplete.save(lot);
			/* *********************************************** */
		...
		if (AFFICHAGE_GENERAL && affichage) {
			...
			System.out.println(this.daoCiviliteComplete.afficherListe(lotPersistant));
			System.out.println(TIRETS);
			System.out.println();
	 ...
	 * <ul>
	 * Teste la méthode <b>retrieve(CiviliteComplete pObject)</b>.<br/>
	 * <li>garantit que retrieve(CiviliteComplete pObject) retrouve 
	...
	public void testRetrieve() 
		...
		= new CiviliteComplete("Pouetr* Pouet");
		...
		/* *********************************************** */
		/* ********************* RETRIEVE **************** */
		objetpersistantInexistant = this.daoCiviliteComplete.retrieve(objetInexistant);
		...
		/* *********************************************** */
		/* ********************* RETRIEVE **************** */
		objetpersistant = this.daoCiviliteComplete.retrieve(objet5);
		
		/* garantit que retrieve(CiviliteComplete pObject) retrouve 
	...
	public void testFindById() 
		...
		/* *********************************************** */
		/* ********************* FINDBYID **************** */
		objetpersistantInexistant = this.daoCiviliteComplete.findById(100L);
		...
		/* *********************************************** */
		/* ********************* FINDBYID **************** */
		objetpersistant = this.daoCiviliteComplete.findById(3L);
	...
	public void testFindAll() 
		...
		/* *********************************************** */
		/* ********************* FINDALL ***************** */
		lotPersistant = this.daoCiviliteComplete.findAll();
	...
	public void testFindAllMax() 
		...
		/* *********************************************** */
		/* ********************* FINDALLMax ************** */
		lotPersistant = this.daoCiviliteComplete.findAllMax(2L);
	...
	public void testFindAllIterable() 
		...
		/* *********************************************** */
		/* ***************** FINDALL(Ite) **************** */
		lotPersistantIterable = this.daoCiviliteComplete.findAll(listIds);
		...
		if (lotPersistant != null) {
			...
			final boolean exists1 = this.daoCiviliteComplete.exists(1L);
			final boolean exists2 = this.daoCiviliteComplete.exists(2L);
	...
	public void testUpdateInexistant() 
		...
		final ICivilite objetInexistant 
		= new CiviliteComplete("civiliteInexistant");
		...
		/* ***************** UPDATE(Objet) **************** */
		objetpersistantInexistant 
			= this.daoCiviliteComplete.update(objetInexistant);
	...
	public void testUpdate() 
		...
		/* ************************************************ */
		/* ***************** UPDATE(Objet) **************** */
		objet1ModifiePersistant = this.daoCiviliteComplete.update(objet1Persistant);
	...
	public void testDeleteInexistant() 
		...
		final ICivilite objetInexistant 
		= new CiviliteComplete("CiviliteComplete inexistante");
	
	
		/* remplit de la table. */
		this.remplirTable(affichage);
		this.daoCiviliteComplete.create(objet1);
		...
		/* ************************************************ */
		/* ***************** DELETE(Objet) **************** */
		resultat = this.daoCiviliteComplete.delete(objetInexistant);
	
		
		nombreObjetsFinal = this.daoCiviliteComplete.count();
		
		lotPersistantApresDelete = this.daoCiviliteComplete.findAll();
		...
		if (AFFICHAGE_GENERAL && affichage) {
			...
			System.out.println(this.daoCiviliteComplete.afficherListe(lotPersistantApresDelete));
			System.out.println(TIRETS);
			System.out.println();
	...
	public void testDelete() 
		...
		/* ************************************************ */
		/* ***************** DELETE(Objet) **************** */
		resultat = this.daoCiviliteComplete.delete(objet1);
	...
	public void testDeleteByIdInexistant() 
		...
		/* **************************************************** */
		/* ***************** DELETEBYID(Objet) **************** */
		this.daoCiviliteComplete.deleteById(100L);
	...
	public void testDeleteById() 
		...
		/* ************************************************ */
		/* ***************** DELETEBYID(Objet) **************** */
		this.daoCiviliteComplete.deleteById(idExistant);
	...
	public void testDeleteByIdBooleanInexistant() 
		...
		resultat = this.daoCiviliteComplete.deleteByIdBoolean(100L);
	...
	public void testDeleteByIdBoolean() 
		...
		/* ************************************************ */
		/* ***************** DELETE(Objet) **************** */
		resultat = this.daoCiviliteComplete.deleteByIdBoolean(idExistant);
	...
	private ICivilite fournirCivilitePersistante(
		...
		if (this.daoCiviliteComplete.exists(pCivilite)) {
			civilitePersistante = this.daoCiviliteComplete.retrieve(pCivilite);
		} else {
			civilitePersistante = this.daoCiviliteComplete.create(pCivilite);
		}
	...
	private void remplirTable(
		...
		final Long nbeObjetsFinal = this.daoCiviliteComplete.count();
	...
	private void viderTable() throws AbstractDaoException {
		...
		this.daoCiviliteComplete.deleteAll();
		
		final Long nbreObjetsFinal = this.daoCiviliteComplete.count();
	 ...
	 * <b>"DAO NON INSTANCIE - this.daoCiviliteComplete est NULL"</b>.<br/>
	 * <br/>
	 */
	private void afficherDAONonInstancie() {
		...
		System.out.println("DAO NON INSTANCIE "
				+ "- this.daoCiviliteComplete est NULL");
		System.out.println(TIRETS);
		System.out.println();
...
} // FIN DE LA CLASSE DaoCiviliteCompleteTest.-------------------------------
