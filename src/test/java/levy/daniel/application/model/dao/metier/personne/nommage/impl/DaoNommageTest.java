...
/**
 * class DaoNommageTest :<br/>
 * <ul>
 * <li>Test JUnit de la classe <b>DaoNommage</b>.</li>
...
public class DaoNommageTest {
	 ...
	 */
	private static final Log LOG = LogFactory.getLog(DaoNommageTest.class);
	...
	/**
	* method CONSTRUCTEUR DaoNommageTest() :<br/>
	* CONSTRUCTEUR D'ARITE NULLE.<br/>
	* <br/>
	*/
	public DaoNommageTest() {
		super();
	...
	public void testCreateNull() throws AbstractDaoException {
		...
		/* daoNommage NON INJECTE. */
		if (this.daoNommage == null) {
			...
			return;
		} // Fin de daoNommage NON INJECTE._______________
		...
		nombreObjetsinitial = this.daoNommage.count();
		...
		try {
			...
			/* *********************************************** */
			/* ********************* CREATION **************** */
			objet1Persistant = this.daoNommage.create(objet1);
			/* *********************************************** */
	...
	public void testCreate() throws AbstractDaoException {
		...
		= new Nommage(PRENOM1, NOM1);
		
		final INommage objet2 
		= new Nommage(PRENOM2, NOM2);
		...
		try {
			...
			/* ********************* CREATION **************** */
			objet1Persistant = this.daoNommage.create(objet1);
			objet2Persistant = this.daoNommage.create(objet2);
			/* *********************************************** */
		...
		final INommage objet3 
			= new Nommage(PRENOM3, NOM3);
		
		try {
			
			/* *********************************************** */
			/* ********************* CREATION **************** */
			objet3Persistant = this.daoNommage.create(objet3);
		...
		final INommage objet4 = new Nommage2("Daniel", "Isaac", "Lévy");
		final INommage objet5 = new Nommage2("Daniel", "Jupiter", "Lévy");
		
		INommage objet4Persistant = null;
		INommage objet5Persistant = null;
		
		objet4Persistant = this.daoNommage2.create(objet4);
		objet5Persistant = this.daoNommage2.create(objet5);
	...
	public void testCreateDoublon() 
		...
		try {
			...
			/* ********************* CREATION **************** */
			objet1Persistant = this.daoNommage.create(objet1);
			objet2PersistantEquals1 = this.daoNommage.create(objet2Equals1);
			/* *********************************************** */
	...
	public void testSaveNull() throws AbstractDaoException {
		...
		try {
			...
			/* *********************************************** */
			/* ********************* CREATION **************** */
			objet1Persistant = this.daoNommage.save(objet1);
			/* *********************************************** */
	...
	public void testSaveDoublon() 
		...
		try {
			...
			/* ********************* CREATION **************** */
			objet1Persistant = this.daoNommage.save(objet1);
			objet2PersistantEquals1 = this.daoNommage.save(objet2Equals1);
			/* *********************************************** */
	...
	public void testPersistNull() throws AbstractDaoException {
		...
		try {
			...
			/* *********************************************** */
			/* ********************* CREATION **************** */
			this.daoNommage.persist(objet1);
			objet1Persistant = this.daoNommage.retrieve(objet1);
			/* *********************************************** */
	...
	public void testPersistDoublon() 
		...
		try {
			...
			/* ********************* CREATION **************** */
			this.daoNommage.persist(objet1);
			this.daoNommage.persist(objet2Equals1);
			objet1Persistant = this.daoNommage.retrieve(objet1);
			objet2PersistantEquals1 = this.daoNommage.retrieve(objet2Equals1);
			/* *********************************************** */
	...
	public void testPersistSousClasseNull() throws AbstractDaoException {
		...
		try {
			...
			/* *********************************************** */
			/* ********************* CREATION **************** */
			this.daoNommage.persistSousClasse(objet1);
			objet1Persistant = this.daoNommage.retrieve(objet1);
			/* *********************************************** */
	...
	public void testPersistSousClasseDoublon() 
		...
		try {
			...
			/* ********************* CREATION **************** */
			this.daoNommage.persistSousClasse(objet1);
			this.daoNommage.persistSousClasse(objet2Equals1);
			objet1Persistant = this.daoNommage.retrieve(objet1);
			objet2PersistantEquals1 = this.daoNommage.retrieve(objet2Equals1);
			/* *********************************************** */
	...
	public void testCreateReturnIdNull() throws AbstractDaoException {
		...
		try {
			...
			/* *********************************************** */
			/* ********************* CREATION **************** */
			idObjetPersistant = this.daoNommage.createReturnId(objet1);
			objet1Persistant = this.daoNommage.findById(idObjetPersistant);
			/* *********************************************** */
	...
	public void testCreateReturnIdDoublon() 
		...
		try {
			...
			/* *********************************************** */
			/* ********************* CREATION **************** */
			idObjet1Persistant = this.daoNommage.createReturnId(objet1);
			idObjet2PersistantEquals1 = this.daoNommage.createReturnId(objet2Equals1);
			objet1Persistant = this.daoNommage.findById(idObjet1Persistant);
			objet2PersistantEquals1 = this.daoNommage.findById(idObjet2PersistantEquals1);
			/* *********************************************** */
	...
	public void testSaveLot() 
		...
		try {
			...
			/* *********************************************** */
			/* ********************* CREATION **************** */
			lotPersistant = (List<INommage>) this.daoNommage.save(lot);
			/* *********************************************** */
		...
		if (AFFICHAGE_GENERAL && affichage) {
			...
			System.out.println(this.daoNommage.afficherListe(lotPersistant));
			System.out.println(TIRETS);
			System.out.println();
	...
	public void testRetrieve() 
		...
		= new Nommage("Pouetr* Pouet", INEXISTANT);
		...
		/* *********************************************** */
		/* ********************* RETRIEVE **************** */
		objetpersistantInexistant = this.daoNommage.retrieve(objetInexistant);
		...
		/* *********************************************** */
		/* ********************* RETRIEVE **************** */
		objetpersistant = this.daoNommage.retrieve(objet5);
	...
	public void testFindById() 
		...
		/* *********************************************** */
		/* ********************* FINDBYID **************** */
		objetpersistantInexistant = this.daoNommage.findById(100L);
		...
		/* *********************************************** */
		/* ********************* FINDBYID **************** */
		objetpersistant = this.daoNommage.findById(3L);
	...
	public void testFindAll() 
		...
		/* *********************************************** */
		/* ********************* FINDALL ***************** */
		lotPersistant = this.daoNommage.findAll();
	...
	public void testFindAllMax() 
		...
		/* *********************************************** */
		/* ********************* FINDALLMax ************** */
		lotPersistant = this.daoNommage.findAllMax(2L);
	...
	public void testFindAllIterable() 
		...
		/* *********************************************** */
		/* ***************** FINDALL(Ite) **************** */
		lotPersistantIterable = this.daoNommage.findAll(listIds);
		...
		if (lotPersistant != null) {
			...
			final boolean exists1 = this.daoNommage.exists(1L);
			final boolean exists2 = this.daoNommage.exists(2L);
	...
	public void testUpdateInexistant() 
		...
		final INommage objetInexistant 
		= new Nommage(INEXISTANT, INEXISTANT);
		...
		/* ***************** UPDATE(Objet) **************** */
		objetpersistantInexistant 
			= this.daoNommage.update(objetInexistant);
	...
	public void testUpdate() 
		...
		/* ************************************************ */
		/* ***************** UPDATE(Objet) **************** */
		objet1ModifiePersistant = this.daoNommage.update(objet1Persistant);
	...
	public void testDeleteInexistant() 
		...
		/* ************************************************ */
		/* ***************** DELETE(Objet) **************** */
		resultat = this.daoNommage.delete(objetInexistant);
	
		
		nombreObjetsFinal = this.daoNommage.count();
		
		lotPersistantApresDelete = this.daoNommage.findAll();
		...
		if (AFFICHAGE_GENERAL && affichage) {
			...
			System.out.println(this.daoNommage.afficherListe(lotPersistantApresDelete));
			System.out.println(TIRETS);
			System.out.println();
	...
	public void testDelete() 
		...
		/* ************************************************ */
		/* ***************** DELETE(Objet) **************** */
		resultat = this.daoNommage.delete(objet1);
	...
	public void testDeleteByIdInexistant() 
		...
		/* **************************************************** */
		/* ***************** DELETEBYID(Objet) **************** */
		this.daoNommage.deleteById(100L);
	...
	public void testDeleteById() 
		...
		/* ************************************************ */
		/* ***************** DELETEBYID(Objet) **************** */
		this.daoNommage.deleteById(idExistant);
	...
	public void testDeleteByIdBooleanInexistant() 
		...
		resultat = this.daoNommage.deleteByIdBoolean(100L);
	...
	public void testDeleteByIdBoolean() 
		...
		/* ************************************************ */
		/* ***************** DELETE(Objet) **************** */
		resultat = this.daoNommage.deleteByIdBoolean(idExistant);
	...
	private void remplirTable(
		...
		final Long nbeObjetsFinal = this.daoNommage.count();
	...
	private void viderTable() throws AbstractDaoException {
		...
		this.daoNommage.deleteAll();
		
		final Long nbreObjetsFinal = this.daoNommage.count();
	 ...
	 * <b>"DAO NON INSTANCIE - this.daoNommage est NULL"</b>.<br/>
	 * <br/>
	 */
...
} // FIN DE LA CLASSE DaoNommageTest.----------------------------------------
