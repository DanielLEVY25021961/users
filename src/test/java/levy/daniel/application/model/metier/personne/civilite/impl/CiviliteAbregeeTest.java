...
/**
 * class CiviliteAbregeeTest :<br/>
 * Test JUnit de la classe CiviliteAbregee.<br/>
 * <br/>
 *
 ...
 *
 */
public class CiviliteAbregeeTest {
	...
	private static final Log LOG 
		= LogFactory.getLog(CiviliteAbregeeTest.class);
	...
	public void testEquals() {
		...
		= new CiviliteAbregee(2L
				, CIVILITE_M);
		
		final ICivilite objet2 
		= new CiviliteAbregee(3L
				, CIVILITE_M);
		
		final ICivilite objet3 
		= new CiviliteAbregee(4L
				, CIVILITE_M);
	 ...
	 * <ul>
	 * Teste la méthode <b>compareTo(CiviliteAbregee pLoc)</b> :
	 ...
	 * <li>garantit que les null sont bien gérés 
	 * dans compareTo(CiviliteAbregee pLoc).</li>
	...
	public void testCompareTo() {
		...
		final ICivilite objetEquals1 
			= new CiviliteAbregee(10L
					, CIVILITE_MLLE);
		
		final ICivilite objetEquals2 
			= new CiviliteAbregee(11L
					, CIVILITE_MLLE);
		 ...
		 * compareTo(CiviliteAbregee pLoc). */		
	...
	public void testToString() {
		...
		assertEquals("objetNull.toString() retourne une chaine : "
				, "CiviliteAbregee [id=null, civilité=null]"
						, objetNull.toString());
		...
		assertEquals("affichage : "
				, "CiviliteAbregee [id=2, civilité=Mme]"
						, objet1.toString());
	...
	public void testGetValeursPossibles() {
		...
		final List<String> listeValeursPossibles 
			= CiviliteAbregee.getValeursPossibles();
