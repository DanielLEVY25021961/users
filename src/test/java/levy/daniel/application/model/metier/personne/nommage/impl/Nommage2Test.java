...
/**
 * class Nommage2Test :<br/>
 * Test JUnit de la classe Nommage2.<br/>
 * <br/>
 *
...
public class Nommage2Test {
	 ...
	 */
	private static final Log LOG = LogFactory.getLog(Nommage2Test.class);

	// *************************METHODES************************************/

	
	 /**
	 * method CONSTRUCTEUR Nommage2Test() :<br/>
	...
	public void testToString() {
		...
		assertEquals("objetNull.toString() retourne une chaine : "
				, "Nommage2 [id=null, nom=null, prenom=null, prenom2=null]"
						, objetNull.toString());
		...
		assertEquals("affichage : "
				, "Nommage2 [id=2, nom=Halliday, prenom=Jean-Philippe, prenom2=Alphonse]"
						, objet1.toString());
	...
	public void testGetEnTeteColonne() {
		...
		if (AFFICHAGE_GENERAL && affichage) {
			...
			System.out.println("enteteNull3 : " + enteteNull3);
		...
		assertEquals("entete3 : ", "prenom2", entete3);
		assertEquals("enteteNull3 : ", "prenom2", enteteNull3);
	...
	public void testGetValeurColonne() {
		...
		assertEquals("valeur3 : ", "Albert", valeur3);
		
	} // Fin de testGetValeurColonne().____________________________________
	


} // FIN DE LA CLASSE Nommage2Test.------------------------------------------
